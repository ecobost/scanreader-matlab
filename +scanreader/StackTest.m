classdef StackTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testattributes (testCase)
            ...
            % 5.1
            scan = scanreader.readstack(testCase.stackFile5_1);
            ...
            % 2016b MultiROI
            scan = scanreader.readstack(testCase.stackFile2016bMultiroi);
        ...
        function test5_1multifile(testCase)
            scan = scanreader.readstack(testCase.stackFile5_1Multifiles);
