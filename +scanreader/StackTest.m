classdef StackTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testattributes (testCase)
            ...
            % 5.1
            scan = scanreader.readscan(testCase.stackFile5_1);
            ...
            % 2016b
            scan = scanreader.readscan(testCase.stackFile2016b);
            ...
            % 2016b MultiROI
            scan = scanreader.readscan(testCase.stackFile2016bMultiroi);
            testCase.verifyEqual(scan.version, '2016b')
            testCase.verifyEqual(scan.isSlowStack, true)
        ...
        function test5_1multifile(testCase)
            scan = scanreader.readscan(testCase.stackFile5_1Multifiles);
